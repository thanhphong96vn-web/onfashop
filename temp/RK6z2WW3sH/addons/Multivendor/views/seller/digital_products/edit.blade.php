...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-10 mx-auto">
            <form class="form form-horizontal mar-top" action="{{ route('seller.digitalproducts.update', $product->id) }}"
                        ...
                        <div class="form-group row" id="category">
                            ...
                            <div class="col-lg-8">
                                <select class="form-control aiz-selectpicker" name="category_id" id="category_id"
                                    data-selected="{{ $selected_category->id }}" required>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                <input type="text" placeholder="{{ translate('Unit price') }}" name="price"
                                    class="form-control" value="{{ $product->highest_price }}" required>
                            </div>
                        </div>
