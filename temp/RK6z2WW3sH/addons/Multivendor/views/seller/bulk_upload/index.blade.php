...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            ...
            <br>
            <div class="">
                <a href="{{ route('seller.pdf.download_category') }}"><button
                        class="btn btn-info">{{ translate('Download Category') }}</button></a>
                <a href="{{ route('seller.pdf.download_brand') }}"><button
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form class="form-horizontal" action="{{ route('seller.bulk_product_upload') }}" method="POST"
