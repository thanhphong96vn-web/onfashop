                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        @php
                            ...
                            $current_stock = (!$product->is_variant && $first_variation) ? $first_variation->current_stock : 0;
                        @endphp
                        ...
                        <div class="no_product_variant" @if ($product->is_variant) style="display:none;" @endif>
                            ...
                            <div class="form-group row">
                                <label class="col-md-3 col-from-label">{{ translate('Current Stock') }} <span
                                        class="text-danger">*</span></label>
                                <div class="col-md-8">
                                    <input type="text" name="current_stock" class="form-control" min="0" value="{{ $current_stock }}" required>
                                </div>
                            </div>
                        </div>
                            ...
                            <ul class="hummingbird-treeview-converter list-unstyled" data-checkbox-name="category_ids[]" data-radio-name="main_category">
                                ...
                                <li id="{{ $category->id }}">{{ $category->name }}</li>
                                    @foreach ($category->childrenCategories as $childCategory)
                                        @include('addon:multivendor::seller.products.child_category', ['child_category' => $childCategory])
                                    @endforeach
                                @endforeach
                            </ul>
                                ...
                                @foreach ($categories as $category)
                                    <li>
                                        <label class="aiz-checkbox">
                                            <input type="checkbox" value="{{ $category->id }}" name="category_ids[]"  data-radio-name="main_category"
