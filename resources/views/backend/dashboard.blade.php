    ...
    @can('show_dashboard')
            ...
            <div class="col-xl-3 col-md-6">
                <div class="shadow-xl rounded-lg pt-5 px-4 mb-5 d-flex justify-content-between align-items-end"
                    ...
                    <div class="pb-5">
                        ...
                        <div class="h2 fw-700">
                            {{ format_price(\App\Models\Order::where('delivery_status', '!=', 'cancelled')->sum('grand_total')) }}
                        </div>
                    </div>
        ...
        <div>
            ...
            <div class="aiz-carousel gutters-10 half-outside-arrow" data-items="7" data-xl-items="6" data-lg-items="4"
                ...
                @foreach (\App\Models\Product::where('published', 1)->where('approved', 1)->orderBy('num_of_sale', 'desc')->limit(12)->get()
            as $key => $product)
