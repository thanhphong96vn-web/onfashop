                    ...
                    @canany(['view_all_manual_payment_methods','view_all_offline_wallet_recharges','view_all_offline_seller_package_payments'])
                        <li class="aiz-side-nav-item">
                            ...
                            <ul class="aiz-side-nav-list level-2">
                                ...
                                @endcan
                                 @can('approve_offline_order_payment')
                                    <li class="aiz-side-nav-item">
                                        <a href="{{ route('orders.payments.list') }}" class="aiz-side-nav-link">
                                            <span class="aiz-side-nav-text">{{translate('Offline Order Payment')}}</span>
                                        </a>
                                    </li>
                                @endcan
                    ...
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            @endif
                             ...
                             <li class="aiz-side-nav-item">
                                    <a href="{{ route('features_control.index') }}" class="aiz-side-nav-link">
