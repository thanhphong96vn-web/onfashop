...
@php
    $current_order = $combined_order->orders->first();
@endphp
...
<body>
    <div style="max-width: 650px;padding:20px;margin:0 auto">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <span class="bold"
                                                style="text-transform: capitalize">{{ translate($current_order->delivery_type) }}</span>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
        ...
        <div style="margin:8px 8px 15px 8px; clear:both">
            <div
                style="padding: 10px 0px 10px 10px;border:1px solid #dedede;border-radius:3px;width:50%;float:left;box-sizing: border-box;">
                <table class="">
            ...
            <div
                style="padding: 10px 14px 10px 0px;border:1px solid #dedede;border-radius:3px;width:50%;float:right;box-sizing: border-box;">
                <table class="text-right">
                     @if ($current_order->type_of_delivery !== 'pickup')
                        <tbody>
                            @php
                    ...
                    @else
                         <tbody>
                            ...
                            <tr>
                                <td class="">{{ $shipping_address->name }}</td>
                            </tr>
                            <tr>
                                <td> {{ $shipping_address->location }}</td>
                            </tr>
                            <tr>
                                <td> {{ translate('Phone') }}{{ $shipping_address->phone }}
                                </td>
                            </tr>
                        </tbody>
                    @endif
