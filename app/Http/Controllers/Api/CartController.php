...
class CartController extends Controller
{
    ...
    public function add(Request $request)
    {
        ...
        $temp_user_id = $request->temp_user_id ?? null;
        ...
        if($user_id){
            $carts = Cart::with(['product', 'variation.combinations.attribute', 'variation.combinations.attribute_value'])->where   ('user_id', $user_id)->get();
        }else if($temp_user_id){
            $carts = Cart::with(['product', 'variation.combinations.attribute', 'variation.combinations.attribute_value'])->where('temp_user_id', $temp_user_id)->get();
        }
    ...
    public function destroy(Request $request)
    {
        ...
        $temp_user_id = $cart->temp_user_id ?? null;
        if ($cart != null) {
            if ((auth('api')->check() && auth('api')->user()->id == $cart->user_id) || ($request->has('temp_user_id') && $request->temp_user_id == $cart->temp_user_id)) {
                $cart->delete();
