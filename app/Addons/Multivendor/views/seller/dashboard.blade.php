...
@section('content')
    ...
    <div class="row">
        ...
        @php 
            $earn_money = Auth::user()->shop->commission_histories()->where('details', 'not like', '%Order refund%')->sum('seller_earning');
                  
                      

            $refund_money =Auth::user()->shop->commission_histories()->where('details', 'like', '%Order refund%')->sum('seller_earning');

            $total_sale = Auth::user()->shop->orders()->where('payment_status', 'paid')->sum('grand_total');
            ...
            <div class="shadow-xl rounded-lg pt-5 px-4 mb-5 d-flex justify-content-between align-items-end"
                ...
                <div class="pb-5">
                    ...
                    <div class="h2 fw-700 text-white">
                        {{ format_price($earn_money - $refund_money, true,) }}
                    </div>
                </div>
            </div>
        </div>
        <div class="col-xl-3 col-md-6">
            <div class="shadow-xl rounded-lg pt-5 px-4 mb-5 d-flex justify-content-between align-items-end"
                ...
                <div class="pb-5">
                    ...
                    <div class="h2 fw-700 text-white">
                        {{ format_price($total_sale - $refund_money, true,) }}
                    </div>
                </div>
            </div>
        </div>
