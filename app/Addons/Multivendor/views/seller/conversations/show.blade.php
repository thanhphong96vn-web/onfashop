  ...
  <div class="aiz-titlebar mt-2 mb-4">
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form class="pt-4" action="{{ route('seller.querries.store') }}" method="POST">
                @csrf
...
@section('script')
    ...
    function refresh_messages(){
       // $.post('{{ route('seller.querries.refresh') }}', {_token:'{{ @csrf_token() }}', id:'{{ encrypt($conversation->id) }}'}, function(data){
       //    $('#messages').html(data);
       // })
    }
