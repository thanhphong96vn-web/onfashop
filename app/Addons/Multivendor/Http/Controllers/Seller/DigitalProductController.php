...
class DigitalProductController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('addon:multivendor::seller.digital_products.index', compact('products', 'sort_search'));
    }
    ...
    public function create()
    {
        ...
        $brands = Brand::all();
        // dd($brands);   
        return view('addon:multivendor::seller.digital_products.create', compact('categories', 'brands'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('seller.digitalproducts.index');
    }
    ...
    public function edit($id)
    {
        ...
        return view('addon:multivendor::seller.digital_products.edit', compact('product', 'categories', 'selected_category'));
    }
