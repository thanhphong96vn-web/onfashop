...
class ConversationController extends Controller
{
    public function index()
    {
        if (get_setting('conversation_system') == 1) {
            ...
            return view('addon:multivendor::seller.conversations.index', compact('conversations'));
        }
        else {
    ...
    public function storeMessage(Request $request)
    {
        ...
        // Broadcast realtime event - make sure message is fresh with relationships
        broadcast(new ConversationMessageSent($message->fresh(['user']), $conversation->id))->toOthers();
