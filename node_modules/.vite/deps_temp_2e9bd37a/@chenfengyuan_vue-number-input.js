...
var normalizeDecimalNumber = (value, times = 1e11) => REGEXP_DECIMALS.test(String(value)) ? Math.round(value * times) / times : value;
    ...
    modelValue: {
      ...
      handler(newValue, oldValue) {
        if (
          ...
          !(isNaN$1(newValue) && typeof oldValue === "undefined") && newValue !== this.value
        ) {
...
var _hoisted_2 = ["name", "value", "min", "max", "step", "readonly", "disabled", "placeholder"];
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock(
    ...
    [
      _ctx.controls ? (openBlock(), createElementBlock("button", {
        key: 0,
...
@chenfengyuan/vue-number-input/dist/vue-number-input.esm.js:
  (*! vue-number-input v2.0.1 | (c) 2018-present Chen Fengyuan | MIT *)
*/
//# sourceMappingURL=@chenfengyuan_vue-number-input.js.map
