...
if(get_setting('offline_payment') == 1){
    ...
    Route::group(['prefix' =>'admin', 'middleware' => ['auth', 'admin']], function(){
        ...
        Route::get("/offline-payment-request-for-order", [ManualPaymentMethodController::class, 'order_payment_lists'])->name("orders.payments.list");
        Route::get('/offline-payment-request-for-order/approved/{id}', [ManualPaymentMethodController::class, 'order_offline_payment_update'])->name('orders.payments.approved');
    }); 
}